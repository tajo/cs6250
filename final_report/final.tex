...
With the increasing use of mobile devices and vehicular networking, ad-hoc networking sees increasingly interesting applications. Since there are often no end-to-end connection at any given time, opportunistic networking is sometimes the best option in rural areas, during disaster relief, in certain military situations and more. We found that it would be valuable to compare prominent opportunistic networks protocols. We have done this using the ONE simulator and a map of the campus of Georgia Institute of Technology, and evaluated the schemes with regard to message delivery probability, energy efficiency, and more.
\end{abstract}
...
{\color{red}
  TODO generate message delivery delay chart (the one in the presentation) in PDF format! Then we can insert it here. Also - should we change from number of packets to the percent of all packets that this protocol delivered? It would maybe be easier to compare distributions in that case. But maybe we should add both, because, why not.
}
...
\begin{figure}
  \includegraphics[scale=0.38, center]{../one_1.5.1-RC2/plots/SprayAndWait_AVG_ENERGY_CONSUMPTION.pdf}
...
\begin{figure}
  \includegraphics[scale=0.38, center]{../one_1.5.1-RC2/plots/Epidemic_AVG_ENERGY_CONSUMPTION.pdf}
...
\begin{figure}
  \includegraphics[scale=0.38, center]{../one_1.5.1-RC2/plots/Epidemic_NUM_DELIVERED_PKTS_IN_WND.pdf}
...
\begin{figure}
  \includegraphics[scale=0.38, center]{../one_1.5.1-RC2/plots/SprayAndWait_NUM_DELIVERED_PKTS_IN_WND.pdf}
...
\begin{figure}
  \includegraphics[scale=0.38, center]{../one_1.5.1-RC2/plots/ProphetRouter_AVG_ENERGY_CONSUMPTION.pdf}
  \caption{Average energy consumption, Prophet routing}
  \label{fig:avg_consumpt:prophet}
\end{figure}

Interestingly enough, the students' energy consumption is flat in fig. \ref{fig:avg_consumpt:prophet}, while the visitors have peaks in roughly the same time periods as Epidemic routing had! Even with the peaks, though, the energy consumption of visitors and bikers is on average lower than that of Epidemic routing, and higher than with Spray and Wait. It seems like Spray and Wait and Prophet routing are good protools in our scenario, given that Prophet routing had slightly higher message delivery probability.
...
\begin{figure}
  \includegraphics[scale=0.38, center]{../one_1.5.1-RC2/plots/Direct_AVG_ENERGY_CONSUMPTION.pdf}
...
\begin{figure}
  \includegraphics[scale=0.38, center]{../one_1.5.1-RC2/plots/FirstContact_AVG_ENERGY_CONSUMPTION.pdf}
